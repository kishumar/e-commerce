  ...
  return (
    <div className='w-[100%] h-[40vh] flex items-center justify-start flex-col bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[10px]'>
      ...
      <form onSubmit={handleSubmit} action='' className='w-[100%] h-[30%] md:h-[50%] flex items-center justify-center mt-[20px] gap-[20px] px-[20px]'>
       ...
       <button
          type="submit"
          className="text-[15px] md:text-[16px] px-[10px] md:px-[30px] py-[12px] md:py-[10px] bg-[#db1717c9] hover:bg-[#db1717c9] text-white flex items-center justify-center gap-[20px] border border-[#80808049] rounded-lg shadow-sm shadow-black cursor-pointer font-semibold"
        >
          Subscribe
        </button>
      </form>
