...
useEffect(()=>{
  ...
  return productData ? (
    <div>
    <div className='w-[100vw] h-[100vh] md:h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-start flex-col lg:flex-row gap-[20px]'>
   <div className='lg:w-[50vw] mt-[70px] flex items-center justify-center flex-col-reverse md:w-[90vw] lg:h-[90vh] h-[50vh] md:gap-[10px] gap-[30px] lg:flex-row'>
    <div className='lg:w-[20%] md:w-[80%] h-[10%] lg:h-[80%] flex items-center justify-center gap-[50px] lg:gap-[20px] lg:flex-col flex-wrap'>
        <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px] bg-slate-300 border-[1px] border-[#80808049] rounded-md'>
            <img className='w-[100%] h-[100%] cursor-pointer rounded-md' src={image1} alt="" onClick={()=>setImage(image1)}/>
        </div>
        <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px] bg-slate-300 border-[1px] border-[#80808049] rounded-md'>
            <img className='w-[100%] h-[100%] cursor-pointer rounded-md' src={image2} alt="" onClick={()=> setImage(image2)}/>
        </div>
        <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px] bg-slate-300 border-[1px] border-[#80808049] rounded-md'>
            <img className='w-[100%] h-[100%] cursor-pointer rounded-md' src={image3} alt="" onClick={()=> setImage(image3)}/>
        </div>
        <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px] bg-slate-300 border-[1px] border-[#80808049] rounded-md'>
            <img className='w-[100%] h-[100%] cursor-pointer rounded-md' src={image4} alt="" onClick={()=>setImage(image4)}/>
        </div>
    </div>

    <div className='lg:w-[60%] w-[80%] lg:h-[70%] h-[70%] border-[1px] border-[#80808049] rounded-md overflow-hidden'>
        <img className='w-[100%] lg:h-[100%] h-[100%] text-[30px] text-white text-center rounded-md object-fill' src={image} alt="" />
    </div>
   </div>

   <div className='lg:w-[50vw] w-[100vw] lg:h-[75vh] h-[40vh] lg:mt-[80px] flex items-start justify-start flex-col py-[20px] px-[30px] md:pb-[20px] md:pl-[20px] lg:pl-[0px] lg:px-[0px] gap-[10px]'>
...
<p className='text-[18px] font-semibold pl-[5px] text-[white] '>{124}</p>
  ...
  and Stylish, breathable cotton shirt with a modern slim fit. Easy to wash, super comfortable, and designed for effortless style.
</p>
...
<p className='border px-5 py-3 text-sm text-white'>
  Reviews (124)
    ...
    <div className='w-[80%] md:h-[150px] h-[220px] bg-[#336397c] border text-white text-[13px] md:text-[15px] lg:text-[20px] px-[10px] md:px-[30px] lg:ml-[100px] ml-[20px]'>
