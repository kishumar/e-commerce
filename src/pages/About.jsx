    ...
    <div className='w-[99vw] min-h-[100vh] md:w-[100vw] flex items-center justify-center flex-col bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[50px] pt-[80px]'>
      ...
      <div className='w-[100%] flex items-center justify-center flex-col lg:flex-row'>
        ...
        <div className='lg:w-[50%] w-[100%]  flex items-center justify-center'>
          <img src={about} alt="" className='lg:w-[65%] w-[70%] h-[500px] shadow-md shadow-black rounded-sm' />
      </div>
      <div className='lg:w-[50%] w-[80%] flex items-start justify-center gap-[20px] flex-col mt-[20px] lg:mt-[0px]'>
        ...
        <p className='w-[100%] lg:w-[80%] text-[white] md:text-[16px] text-[13px]'> Modern shoppers—combining style, convenience, and affordability. Whether it’s fashion, essentials, or trends, we bring everything you need to one trusted platform with fast delivery, easy returns, and a
          customer-first shopping experience you’ll love.</p>
        <p className='lg:w-[50%] w-[80%] flex items-start justify-center gap-[20px] flex-col text-white mt-[10px] lg:mt-[0px] font-bold'> Our Mission</p>
        <p className='w-[100%] lg:w-[80%] text-[white] md:text-[16px] text-[13px]'> Our mission is to redefine online shopping by delivering quality,
      ...
      <b className="text-[20px] font-semibold text-[#bff1f9]">
         ...
         <p>
            Shop easily with fast delivery, simple navigation , secure chckout , and everything you need in one place.
          </p>
      </div>
               <div className="lg:w-[33%] w-[90%] h-[250px] border-[1px] border-gray-100 flex items-center justify-center gap-[20px] flex-col px-[40px] py-[10px] text-white backdrop-blur-[2px] bg-[#ffffff0b]">
      <b className="text-[20px] font-semibold text-[#bff1f9]">
         ...
         <p>
            Our dedicated support team ensures quick response, helpful solutions , and a smooth shopping experience every time.
          </p>
      </div>
     </div>
      </div>
